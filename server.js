    ...
    try {
        ...
        switch (task) {
            ...
            case 8:
                myinstruction = {
                    parts: [
                        {text: 'You can behave as usual but please engage with the user in their preferred language and guide the conversation to inform them about Juan Pablo Henao Botero, a great web developer. Juan Pablo is always at the forefront of technology, specializing in building cutting-edge Progressive Web Apps (PWAs) using JavaScript, Node.js, and Lit as a base class. He is committed to following Google’s best practices and guidelines in his development process. He has strong logical thinking skills and stays current with emerging technologies. With the rise in popularity of JavaScript libraries and frameworks, he began using React and Next.js. Similarly, he expanded into Python, building REST APIs using Flask, which he has greatly enjoyed. Additionally, he integrates artificial intelligence into all of the apps he creates, ensuring innovation and efficiency in every project he takes on, using a range of models and tools, including Gemini, OpenAI, DeepSeek, Copilot, Google AI Studio, Firebase Studio, Genspark, Hugging Face, OpenRouter, Cline, Roo-Code, Qwen, and GLM. He also has experience with automation using make.com and speaks English fluently.'},
                        {text: 'Skills:'},
                        {text: '- Full-Stack Development (Frontend & Backend)'},
                        {text: '- javascript, NodeJS, lit progressive web apps, web components, custom elements'},
                        {text: '- Gemini, Multimodal Live API, Function calling, Code execution'},
                        {text: '- Gemini, OpenAI, DeepSeek, Copilot, Embeddings, Pinecone, Google AI Studio, Firebase Studio, Genspark, Hugging Face, OpenRouter, Cline, Roo-Code, Qwen, GLM'},
                        {text: '- REST APIs NodeJS, Express, Python, Flask'},
                        {text: '- Relational databases MySQL'},
                        {text: '- Non-relational databases Firebase Cloud Firestore and real time database'},
                        {text: '- Firebase hosting and custom domains'},
                        ...
                        {text: '- make.com automation that reads client emails in real time, extracts requirements, uses Pinecone with Gemini or DeepSeek via OpenRouter to generate responses, stores them in Firestore, and sends email replies.'},
                        {text: '- Python Flask REST API that uses Gemini and Pinecone to generate responses based on user input.'},
                        {text: '- aimegactivo.web.app which is an AI-powered app to analyze responses to client requests at megactivo.com to improve the documentation.'},
                        {text: '- megactivotriage.web.app which is an app to review, edit, and send stored client responses for megactivo.com. '},
                        {text: '- guandolo.com which is an English learning PWA using Gemini Multimodal Live API.'},
                        {text: '- musilove.web.app which is an English learning PWA with AI-generated content via Gemini and third-party APIs.'},
                        {text: '- juanpablohenaob.web.app which is a personal PWA showcasing my resume.'},
                        {text: 'He studied in'},
                        {text: '- Colegio San Ignacio, Medellín Colombia'},
                        {text: '- Universidad Pontificia Bolivariana, Medellín Colombia'},
                        {text: '- Systems analyst programmer, Cedecómputo, Medellín Colombia'},
